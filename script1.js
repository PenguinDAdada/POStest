// ===== 設定 =====
const GAS_URL = "https://script.google.com/macros/s/AKfycbyPzsIOscEHpJWvjp6ueBvB0eC6Rb1Ip8Zbw7ut-WsBotfU48A-wrOshw5RlwCXMo-4tg/exec";
...
async function deleteHistory(index, record) {
  ...
  // GASに送信（完了を待つ）
  await postData({ type: "deleteHistory", record: { ...record, index } });

  // GASから最新データを取得してから自動更新再開
  await loadData();
